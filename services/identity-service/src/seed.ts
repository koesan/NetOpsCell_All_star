...
async function seed() {
  ...
  const demoUsers: Partial<User>[] = [
    ...
    // Saha ekipleri: Istanbul'un iki yakasina dagilmis 6 ekip. Us konumlari gercek
    // ilce merkezleridir — AI atama skorundaki mesafe_yakinlik bileseni ve haritadaki
    // rota/canli ilerleme animasyonu bu koordinatlardan beslenir.
    {
    ...
    {
      role: Role.SAHA_TEKNISYENI,
      email: "saha.avrupa.donanim@netopscell.com",
      name: "Burak",
      surname: "Celik",
      passwordHash,
      expertise: ["DONANIM", "GUC_KESINTISI"],
      region: ["Bakirkoy", "Beylikduzu"],
      latitude: 40.9744,
      longitude: 28.8719,
      status: UserStatus.ACTIVE,
    },
    {
      role: Role.SAHA_TEKNISYENI,
      email: "saha.maslak@netopscell.com",
      name: "Selin",
      surname: "Yildiz",
      passwordHash,
      expertise: ["YAZILIM", "BAGLANTI", "ISINMA"],
      region: ["Sariyer", "Sisli"],
      latitude: 41.1121,
      longitude: 29.0208,
      status: UserStatus.ACTIVE,
    },
    {
      role: Role.SAHA_TEKNISYENI,
      email: "saha.anadolu.guney@netopscell.com",
      name: "Emre",
      surname: "Kilic",
      passwordHash,
      expertise: ["DONANIM", "BAGLANTI"],
      region: ["Maltepe", "Kartal", "Pendik"],
      latitude: 40.9351,
      longitude: 29.131,
      status: UserStatus.ACTIVE,
    },
